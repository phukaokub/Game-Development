...
upgrade_image_list = [sprite_collection["noselection"].image, sprite_collection["selection1"].image,
                      sprite_collection["selection2"].image, sprite_collection["selection3"].image,
                      sprite_collection["selection4"].image]

upgrade_icon_image_list = [sprite_collection["icon1"].image, sprite_collection["icon2"].image,
                           sprite_collection["icon3"].image, sprite_collection["icon4"].image]

powerup_image_list = [sprite_collection["Bomb"].image, sprite_collection["Penetrate"].image]

bomb_image = sprite_collection["Bomb"].image

penetrate_image = sprite_collection["Penetrate"].image
